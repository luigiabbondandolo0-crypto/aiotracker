          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="padding:40px 20px;">
            <tr><td align="center">
              <table width="480" cellpadding="0" cellspacing="0"
                style="background:#0F172A;border:1px solid #1E2D42;border-radius:16px;overflow:hidden;">
                <!-- Header -->
                <tr>
                    ...
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td style="padding-left:12px;">
                          <span style="font-size:18px;font-weight:700;color:#F1F5F9;">AIO Tracker</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="padding:32px 40px;">
                    ...
                    <p style="margin:24px 0 0;font-size:12px;color:#475569;line-height:1.6;">
                      Il link scade tra <strong style="color:#64748B;">1 ora</strong>.<br>
