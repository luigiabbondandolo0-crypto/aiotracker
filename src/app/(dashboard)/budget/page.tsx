  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">Traccia spese ed entrate mensili</p>
      </div>
      <div className="bg-[#111827] border border-[#1e2a3a] rounded-xl p-8 text-center">
        <p className="text-4xl mb-3">💰</p>
        <p className="text-white font-medium">Nessuna transazione</p>
        <p className="text-slate-500 text-sm mt-1">Aggiungi la prima transazione</p>
